...
function addBookNowButton(){
	echo '<a id="book-now"  class="button secondary-button" href="/book-now">Book Now</a>';
}

add_action('genesis_header', 'addBookNowButton');

add_filter( 'gform_submit_button', 'form_submit_button', 10, 2 );
function form_submit_button( $button, $form ) {
    return "<button class='button primary-button gform-submit-button' id='gform_submit_button_{$form['id']}'><span>Request Appointment</span></button>";
}